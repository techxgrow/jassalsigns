export const data = {
  ...
  productPage: {
    vehiclewraps: {
      heading: "High-Performance Vehicle Wraps in sacramento",
      introHeading: "Drive Your Brand Further.",
      para1: `Mobile advertising is one of the most cost-effective ways to reach a local audience. At Jassal Signs, we combine high-performance vinyl technology with expert installation to protect your vehicle’s paint while promoting your business. With over 30 years in the industry, we know how to design graphics that remain legible at highway speeds and durable enough to survive California's gravel and road salt.`,
    ...
    printmedia: {
      heading: "High-Impact Commercial Printing in sacramento",
        ...
        bulletList: [
          {
            ...
            value:
              "Heavy-duty vinyl banners for events, grand openings, and 'Now Hiring' notices. Weatherproof and built for sacramento's climate.",
          },
          {
    ...
    pylonsigns: {
      heading: "High-Visibility Pylon Signs in sacramento",
      introHeading: "Command the Roadside. Capture Every Lead.",
      para1: `In a busy city like sacramento, visibility is everything. A pylon sign is more than just a sign; it’s a landmark. These freestanding structures are designed to be seen from hundreds of yards away, making them essential for businesses located near high-speed roads or tucked away in large shopping plazas. At Jassal Signs, we handle the entire process—from structural engineering and city permits to fabrication and heavy-duty installation. With 30 years of experience, we ensure your pylon is built to stay level and look pristine through California’s toughest winds and winters.`,
      ...
      consultationObj: {
        ...
        faqs: [
          {
            question: "How tall can a pylon sign be in sacramento?",
            answer:
              "Height restrictions are governed by local municipal bylaws and vary depending on the zone (commercial, industrial, etc.). We are experts in sacramento and Calgary signage bylaws and will help you determine the maximum allowable height for your specific location.",
          },
          {
          ...
          },
          {
            ...
            answer:
              "Yes. Every pylon we build is engineered to meet California’s wind-load requirements. We use heavy-duty steel columns and deep concrete foundations to ensure the sign remains safe and stable even during high-wind events.",
          },
        ],
      },
    },
      ...
      consultationObj: {
        ...
        bulletList: [
          ...
          },
          {
            ...
            value:
              "Tactile and Braille-integrated signage to ensure your building meets all sacramento accessibility standards.",
          },
        ],
        faqs: [
          {
    ...
    outdoorsigns: {
      ...
      consultationObj: {
        ...
        faqs: [
          {
            question:
              "How do your signs handle sacramento’s extreme winter weather?",
            answer:
              "We use industrial-grade aluminum, UV-protected coatings, and specialized adhesives specifically tested for the -40°C to +30°C temperature swings in California. Our signs are built to resist fading, cracking, and rust.",
          },
          {
            question: "Do I need a permit for my outdoor sign?",
            answer:
              "In most cases, yes. Signage bylaws in sacramento and Calgary can be complex. We provide expert guidance on local regulations and can assist in the permit application process to ensure your sign is fully compliant.",
          },
          {
            question:
    ...
    otherproducts: {
      heading: "Specialized Signage & Custom Solutions in sacramento",
        ...
        faqs: [
          {
            ...
            answer:
              "Yes. We are well-versed in California's safety signage requirements, including OH&S standards and ADA (Accessibility) compliance. We ensure your Braille, tactile, and safety signs meet all legal mounting and contrast specifications.",
          },
          {
            question:
  ...
  contactPage: {
    ...
    sacramento: {
      ...
      address: "3273 Parsons Rd NW, sacramento, AB T6N 1B4, Canada",
      location:
