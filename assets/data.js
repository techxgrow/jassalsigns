export const data = {
  ...
  productPage: {
    vehiclewraps: {
      heading: "High-Performance Vehicle Wraps in Calgary",
    ...
    channelletters: {
      heading: "Custom Channel Letters in Calgary",
    ...
    printmedia: {
      heading: "High-Impact Commercial Printing in Calgary",
        ...
        bulletList: [
          {
            ...
            value:
              "Heavy-duty vinyl banners for events, grand openings, and 'Now Hiring' notices. Weatherproof and built for Calgary's climate.",
          },
          {
    ...
    pylonsigns: {
      heading: "High-Visibility Pylon Signs in Calgary",
      introHeading: "Command the Roadside. Capture Every Lead.",
      para1: `In a busy city like Calgary, visibility is everything. A pylon sign is more than just a sign; it’s a landmark. These freestanding structures are designed to be seen from hundreds of yards away, making them essential for businesses located near high-speed roads or tucked away in large shopping plazas. At Jassal Signs, we handle the entire process—from structural engineering and city permits to fabrication and heavy-duty installation. With 30 years of experience, we ensure your pylon is built to stay level and look pristine through British Columbia’s toughest winds and winters.`,
      ...
      consultationObj: {
        ...
        faqs: [
          {
            question: "How tall can a pylon sign be in Calgary?",
            answer:
              "Height restrictions are governed by local municipal bylaws and vary depending on the zone (commercial, industrial, etc.). We are experts in Calgary and Calgary signage bylaws and will help you determine the maximum allowable height for your specific location.",
          },
          {
          ...
          },
          {
            ...
            answer:
              "Yes. Every pylon we build is engineered to meet British Columbia’s wind-load requirements. We use heavy-duty steel columns and deep concrete foundations to ensure the sign remains safe and stable even during high-wind events.",
          },
        ],
      },
    },
      ...
      consultationObj: {
        ...
        bulletList: [
          ...
          },
          {
            ...
            value:
              "Tactile and Braille-integrated signage to ensure your building meets all Calgary accessibility standards.",
          },
        ],
        faqs: [
          {
    ...
    outdoorsigns: {
      ...
      consultationObj: {
        ...
        faqs: [
          {
            question:
              "How do your signs handle Calgary’s extreme winter weather?",
            answer:
          ...
          },
          {
            ...
            answer:
              "In most cases, yes. Signage bylaws in Calgary and Calgary can be complex. We provide expert guidance on local regulations and can assist in the permit application process to ensure your sign is fully compliant.",
          },
          {
            question:
    ...
    otherproducts: {
      heading: "Specialized Signage & Custom Solutions in Calgary",
        ...
        faqs: [
          {
            ...
            answer:
              "Yes. We are well-versed in British Columbia's safety signage requirements, including OH&S standards and ADA (Accessibility) compliance. We ensure your Braille, tactile, and safety signs meet all legal mounting and contrast specifications.",
          },
          {
            question:
  ...
  contactPage: {
    Calgary: {
      ...
      address: "7728 128 St Unit 101, Calgary, BC V3W 0R6, Canada",
      location:
    ...
    Calgary: {
      ...
      address: "3273 Parsons Rd NW, Calgary, AB T6N 1B4, Canada",
      location:
