...
//  }
  ...
  return (
    <div className="md:max-w-[85vw] max-w-[95vw]  mx-auto px-6 md:px-0 text-gray-800 md:py-12 py-10  " id="contact">
...
>
  ...
  <p className="flex items-start gap-2">
    ...
    <span>
      {data && data?.contactPage[`${city}`]?.address}
    </span>
  </p>
</div>
    ...
    <div className="h-[250px] mt-6  overflow-hidden">
      ...
      ></iframe>
        ...
        <div className="md:col-span-2 text-gray-800 py-6 ">
          <h3 className="text-3xl font-bold mb-2 text-gray-800">POST YOUR QUERY</h3>
