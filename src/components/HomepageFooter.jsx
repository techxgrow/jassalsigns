...
const HomepageFooter = () => {
  return (
    <footer className="w-full text-white py-12 px-4 md:px-8 lg:px-12 relative z-50 bg-black/80 backdrop-blur-md border-t border-white/10 mt-20">
      <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
        ...
        <div className="lg:col-span-3 flex flex-col items-start gap-6">
          ...
          <div className="flex gap-4">
            <a
              ...
              aria-label="Facebook"
              className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#ED1D26] hover:text-white transition-all duration-300"
            >
              <FaFacebook size={18} />
            </a>
            <a
        ...
        <div className="lg:col-span-2">
          <h3 className="text-white font-bold font-grotesk tracking-wider mb-6 flex items-center gap-2">
            <span className="w-1 h-4 bg-[#ED1D26]"></span> QUICK LINKS
          </h3>
        ...
        <div className="lg:col-span-2">
          <h3 className="text-white font-bold font-grotesk tracking-wider mb-6 flex items-center gap-2">
            <span className="w-1 h-4 bg-[#ED1D26]"></span> SERVICES
          </h3>
        ...
        <div className="lg:col-span-2">
          <h3 className="text-white font-bold font-grotesk tracking-wider mb-6 flex items-center gap-2">
            <span className="w-1 h-4 bg-[#ED1D26]"></span> LOCATIONS
          </h3>
        ...
        <div className="lg:col-span-3">
          <h3 className="text-white font-bold font-grotesk tracking-wider mb-6">
          ...
          <form className="space-y-4">
            <div className="relative">
              <input
                type="text"
                placeholder="Name"
                className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-[#ED1D26] focus:bg-white/10 transition-all placeholder:text-gray-600"
              />
            </div>
            <div className="relative">
              <input
