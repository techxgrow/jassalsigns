    ...
    <footer className="bg-[#111] text-white py-12 px-5 bg-[url('/footer-bg.png')] bg-cover bg-center">
      <div className="mx-auto md:max-w-[1240px] max-w-[95vw] grid grid-cols-1 md:grid-cols-5 gap-10">
        ...
        <div className="md:block">
          <h2 className="text-lg font-semibold mb-6 font-grotesk underline underline-offset-8">QUICK LINKS</h2>
        ...
        <div className="hidden md:block">
          <h2 className="text-lg font-semibold mb-6 font-grotesk underline underline-offset-8">SERVICES</h2>
        ...
        <div className="md:block hidden">
          <h2 className="text-lg font-semibold mb-6 font-grotesk underline underline-offset-8">British Columbia</h2>
          <ul className="space-y-3 text-white text-sm">
            {[
          ...
          <h2 className="text-lg font-semibold mb-2 mt-6 font-grotesk underline underline-offset-8">Alberta</h2>
          <ul className="space-y-3 text-white text-sm">
            {[
        ...
        <div className="md:block hidden">
          <h2 className="text-lg font-semibold mb-6 font-grotesk underline underline-offset-8">United States</h2>
          <ul className="space-y-3 text-white text-sm">
        ...
        <div className="md:hidden grid grid-cols-2 gap-x-10 gap-y-8">
          <div>
            <h2 className="text-lg font-semibold mb-4 font-grotesk underline underline-offset-8">SERVICES</h2>
          ...
          <div>
            <h2 className="text-lg font-semibold mb-4 font-grotesk underline underline-offset-8">LOCATIONS</h2>
